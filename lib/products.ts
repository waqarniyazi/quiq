...
const vitaminD: Product = {
    ...
    image: '/first image.png', imageFolder: '/product/vitamin-d',
...
const vitaminB12: Product = {
    ...
    image: '/first image.png', imageFolder: '/product/vitamin-b12',
...
const ferritin: Product = {
    ...
    image: '/first image.png', imageFolder: '/product/iron-deficiency',
...
const tsh: Product = {
    ...
    image: '/first image.png', imageFolder: '/product/tsh',
...
const hba1c: Product = {
    ...
    image: '/first image.png', imageFolder: '/product/hba1c',
...
const cholesterol: Product = {
    ...
    price: 89, originalPrice: 199, currency: '₹', category: 'Wellness & Lifestyle',
    image: '/first image.png', imageFolder: '/product/cholesterol',
...
const triglycerides: Product = {
    ...
    price: 89, originalPrice: 199, currency: '₹', category: 'Wellness & Lifestyle',
    image: '/first image.png', imageFolder: '/product/triglycerides',
...
const lactose: Product = {
    ...
    price: 89, originalPrice: 199, currency: '₹', category: 'Wellness & Lifestyle',
    image: '/first image.png', imageFolder: '/product/lactose-intolerance',
...
const hPylori: Product = {
    ...
    price: 89, originalPrice: 199, currency: '₹', category: 'Wellness & Lifestyle',
    image: '/first image.png', imageFolder: '/product/h-pylori',
...
const petAllergy: Product = {
    ...
    image: '/first image.png', imageFolder: '/product/pet-allergy',
...
const dustAllergy: Product = {
    ...
    price: 79, originalPrice: 179, currency: '₹', category: 'Wellness & Lifestyle',
    image: '/first image.png', imageFolder: '/product/dust-allergy',
    rating: 4.6, reviewCount: 134, inStock: true,
...
const psa: Product = {
    ...
    image: '/first image.png', imageFolder: '/product/psa',
...
const crp: Product = {
    ...
    image: '/first image.png', imageFolder: '/product/crp',
...
const dengue: Product = {
    ...
    image: '/first image.png', imageFolder: '/product/dengue',
    rating: 4.6, reviewCount: 287, inStock: true,
...
const hiv: Product = {
    ...
    image: '/first image.png', imageFolder: '/product/hiv',
    rating: 4.9, reviewCount: 523, inStock: true,
...
const malaria: Product = {
    ...
    price: 79, originalPrice: 199, currency: '₹', category: 'Infectious Diseases',
    image: '/first image.png', imageFolder: '/product/malaria',
...
const procalcitonin: Product = {
    ...
    image: '/first image.png', imageFolder: '/product/procalcitonin',
    rating: 4.8, reviewCount: 87, inStock: true,
...
const troponinI: Product = {
    ...
    image: '/first image.png', imageFolder: '/product/troponin-i',
    rating: 4.9, reviewCount: 76, inStock: true,
...
const troponinT: Product = {
    ...
    price: 99, originalPrice: 399, currency: '₹', category: 'Critical & Emergency',
    image: '/first image.png', imageFolder: '/product/troponin-t',
    rating: 4.8, reviewCount: 64, inStock: true,
...
const drugsOfAbuse: Product = {
    ...
    image: '/first image.png', imageFolder: '/product/drugs-of-abuse',
    rating: 4.5, reviewCount: 92, inStock: true,
